...
# How to run locally
In order to run, make sure express and socket.io are installed in the server folder, as well as npm init. Use "npm start" in the server directory. Two browsers can be open to observe the functionality. The server can be run on port 5000: http://localhost:5000/
