...
# How to run locally
Run with "npm start" in the server directory. Two browsers can be open to observe the functionality. The server can be run on port 5000: http://localhost:5000/
